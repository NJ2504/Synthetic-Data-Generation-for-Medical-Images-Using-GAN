...
# Model Building
rfc2 = RandomForestClassifier(random_state=25)
rfc2.fit(X_train, y_train)
y_val_pred = rfc2.predict(X_val)
...
plt.title('Phase 2 Confusion Matrix (RFC)')
plt.show()
...
plt.xlabel('Predicted Labels')
plt.ylabel('True Labels')
plt.title('Phase 2 Test Set Confusion Matrix (RFC)')
plt.show()