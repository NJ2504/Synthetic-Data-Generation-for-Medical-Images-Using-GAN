...
# Model Building
rfc5 = RandomForestClassifier(random_state=25)
rfc5.fit(X_train, y_train)
y_val_pred = rfc5.predict(X_val)
...
plt.xlabel('Predicted Labels')
plt.ylabel('True Labels')
plt.title('Phase 5 Test Set Confusion Matrix (RFC)')
plt.show()