...
images_phase_1 = np.array(benign_images + malignant_images + synthetic_images_phase_3)
labels_phase_1 = np.array(benign_labels + malignant_labels + synthetic_labels_phase_3)
...
# Data Splitting 
X_train, X_val, y_train, y_val = train_test_split(images_flat_phase_1, labels_phase_1, test_size=0.3, random_state=25, stratify=labels_phase_1)
...
plt.title('Phase 3 Confusion Matrix (Logistic Regression)')
plt.show()
